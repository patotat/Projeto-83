...
Precisamos reverter os elementos presentes dentro da array "age" para estampar o valor da 
idade dos respectivos membros da família.
Após ordenar a array "age", todos os elementos precisam ser organizados em 
ordem crescente, e nosso álbum de família consiste na lista oposta, na qual o
 primeiro membro é o avô, seguido pelo pai, assim em diante, ou seja, em ordem decrescente.
...
function update()
{
    ...
    */
    ...
    var maxNumber = Math.max.apply(Math, );
    console.log("A maior idade é: ",maxNumber  );
